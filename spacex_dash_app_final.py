...
def get_payload_chart(entered_site,entered_payload):
    if entered_site == 'All Sites':
        ...
        hover_data=['Launch Site'],title='Correlation Between Payload Mass(Kg) and Success Rate for All Sites')
    else:
        ...
        title='Correlation Between Payload Mass(Kg) and Success Rate for {}'.format(entered_site))
    return(fig)
